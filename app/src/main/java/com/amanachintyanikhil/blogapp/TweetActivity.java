...
public class TweetActivity extends Activity {
	...
	private class DownloadTwitterTask extends AsyncTask<String, Void, String> {
		final static String CONSUMER_KEY = "y5Bg6YO2fM9Y9S3gwBrdnNIH7";
		final static String CONSUMER_SECRET = "Omi4lTpahtod9qYshJqPSyEJBpX3ZmApjxIsiqfbWIiXrDkf32";
		final static String TwitterTokenURL = "https://api.twitter.com/oauth2/token";
		final static String TwitterStreamURL = "https://api.twitter.com/1.1/statuses/user_timeline.json?screen_name=";
		final ProgressDialog dialog = new ProgressDialog(TweetActivity.this);
